...
dates = ["Dec-1","Dec-2","Dec-3","Dec-4","Dec-5","Dec-6","Dec-7","Dec-8"]
results = Dict("Dec-1" => [989824, 66432240], "Dec-2" => [546,275], "Dec-3" => [280,4355551200], "Dec-4" => [192,101], "Dec-5" => [896,659], "Dec-6" => [6542,3299], "Dec-7" => [205,80902],"Dec-8"=>[2058,1000])
